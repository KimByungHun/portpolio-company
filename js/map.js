...
const branch_btns = document.querySelectorAll(".loacation .inner .branch li"); 
...
//교통정보 표시하기 ---------------------------------------------------
const t_on = document.querySelectorAll(".location .inner .traffic li")[0];  
const t_off = document.querySelectorAll(".location .inner .traffic li")[1]; 
